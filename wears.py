...
class WearsFunctions:
    ...
    def plot_bottles(percentage_filled,bottle_size):
        ...
        fig.update_layout(
            ...
            height=1050*float(norm_mL_start),
            width=1400*float(norm_mL_start)
        )
